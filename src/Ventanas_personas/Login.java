...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        initComponents();
        //Localizando la ventana en el centro
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        frameRegistrar.setFormVisible(null, true);  
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(user.equals("")){
             JOptionPane.showMessageDialog(null, "Complete el campo user");
             return;
        }
        ...
        //Haciendo la consulta con el username y el password
        Persona person = new Persona();
        person.logear(user, pass, this);
